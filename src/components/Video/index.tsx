          ...
          <div className="w-full px-4">
            ...
            >
              <div className="relative aspect-[77/40] items-center justify-center">
                <img src={videoThumb} alt="warlock image" />
                {/* <div className="absolute right-0 top-0 flex h-full w-full items-center justify-center">
                  <button
                    aria-label="video play button"
                    onClick={() => setOpen(true)}
                    className="flex h-[70px] w-[70px] items-center justify-center rounded-full bg-white bg-opacity-75 text-primary transition hover:bg-opacity-100 border-none outline-none"
                  >
                    <svg
                      width="16"
                      height="18"
