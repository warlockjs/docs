...
export class UniqueRule extends Rule {
  ...
  /**
   * Filter without current id
   */
  protected exceptId = false;
  ...
  /**
   * Run the rule except for current id
   */
  public exceptCurrentId(exceptCurrentId = true) {
    this.exceptId = exceptCurrentId;
    return this;
  }
  ...
  public async validate() {
    ...
    if (this.exceptId) {
      this.exceptValue = this.request.input("id");
      this.exceptColumn = "id";
    }
