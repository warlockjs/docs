  ...
  for (const fileName of files) {
    ...
    if (file === "index") {
      ...
      imports.push(
        ...
        `import { setLogConfigurations } from "@warlock.js/core";`,
      );
    ...
    //     `import { setDatabaseConfigurations } from "@warlock.js/cascade";`,
    //   );
    ...
    // }
      ...
      imports.push(
        ...
        `import { setMailConfigurations } from "@warlock.js/core";`,
      );
