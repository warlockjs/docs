...
By default Mongez MongoDB is shipped with an instance of the query manager, you can import it directly from the package.

```ts title="src/app.ts"
import { query } from "@mongez/mongodb";
