...
import { Model, Casts } from "@mongez/mongodb";
...
import { Model, Casts, castModel } from "@mongez/mongodb";
...
Another good feature of `castModel` is that it handles both types, if the given value is an array then it will return an array of embedded documents, otherwise it will return only one object of embedded data.
...
```ts title="src/models/user.ts"
import { Model, Casts, castEmail } from "@mongez/mongodb";
...
```ts title="src/models/user.ts"
import { Model, Casts, oneOf } from "@mongez/mongodb";
...
```ts title="src/models/user.ts"
import { Model, Casts, arrayOf } from "@mongez/mongodb";
...
```ts title="src/models/user.ts"
import { Model, Casts, shapedArray, ShapedArrayType } from "@mongez/mongodb";
...
```ts title="src/models/user.ts"
import { Model, Casts, randomInteger } from "@mongez/mongodb";
...
```ts title="src/models/user.ts"
import { Model, Casts, expiresAfter } from "@mongez/mongodb";
