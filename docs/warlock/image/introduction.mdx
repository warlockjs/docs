...
Warlock.js is shipped with [Sharp](https://sharp.pixelplumbing.com) which is a high performance Node.js image processing library.

## Upload an image

When [Uploading images](./../upload/compressing-images) and with the **compress** mode activated, Warlock.js uses Sharp to compress the images.

## Manual image processing

Warlock.js provides a simple way to process images using Sharp by wrapping the `Sharp` class by Warlock.js `Image` class.
...
Another good and important feature is to add watermarks in the images, luckily, Warlock.js provides a simple way to do that.
