...
When `Warlock` was built, it was built with the concept of ease of use so the frontend developers can easily use it without the need to learn a lot of backend stuff.

This will help you to build your frontend application faster and easier without the need to wait for the backend team to finish their work.
