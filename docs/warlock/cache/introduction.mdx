...
Warlock framework uses the [@warlock.js/cache](/docs/cache/introduction) package for caching. This page covers **framework-specific features only**. For comprehensive cache API documentation, see the [Cache Package Documentation](/docs/cache/introduction).

:::info Full API Documentation
All cache features work in Warlock exactly as documented in the standalone package. See [Cache Package Documentation](/docs/cache/introduction) for:
...
| Feature | Standalone | Warlock Framework |
|---------|-----------|-------------------|
...
- [Cache Package Documentation](/docs/cache/introduction) - Complete API reference
- [Repository Caching](./../repositories/caching) - Repository-specific caching
- [Restful API](./../http/restful) - RESTful endpoint caching
- [Cache Configurations](/docs/cache/configurations) - Configuration options
