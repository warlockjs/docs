...
Warlock framework uses the [@warlock.js/cache](../../cache/introduction) package for caching. This page covers **framework-specific features only**. For comprehensive cache API documentation, see the [Cache Package Documentation](../../cache/introduction).

:::info Full API Documentation
All cache features work in Warlock exactly as documented in the standalone package. See [Cache Package Documentation](../../cache/introduction) for:
