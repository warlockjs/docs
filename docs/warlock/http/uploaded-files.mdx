...
Uploading files in an API application is crucial, and Warlock.js provides a simple way to handle file uploads.

## How it works

Uploaded files are used in `multipart/form-data` requests, and Warlock.js handles them automatically.
