...
Warlock.js provides a simple way to send emails using [NodeMailer](https://nodemailer.com).

## Setup

By default Warlock.js installs **nodemailer** so you don't need to install it manually.
...
Luckily, Warlock.js uses a simple react component to render the email body, so you can use react to build your emails.
