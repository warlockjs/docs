...
Warlock.js supports localization out of the box, it heavily depends on [Mongez Localization](https://github.com/hassanzohdy/mongez-localization).

## How it works

As you already now know, Warlock.js autoloads many files automatically, including the localization files.
...
Warlock.js will import and configure the localization files automatically.
...
This approach is used widely in Warlock.js and MonPulse as well.
