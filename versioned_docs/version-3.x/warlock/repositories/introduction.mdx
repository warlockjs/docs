...
The [cache](/docs/cache/introduction) system is fully integrated with repositories, it allows you to easily cache/recache/uncache any type of data most of the time without any intervention from your side.
